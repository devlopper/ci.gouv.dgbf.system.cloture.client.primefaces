...
public class ImputationReadController extends AbstractReadController implements Serializable {
	...
	private Layout buildInfosLayout() {
		...
		addLabelValue(cellsMaps, "Exercice", imputation.getExerciseAsString());
		addLabelValue(cellsMaps, "Activité", imputation.getActivityAsString());
		addLabelValue(cellsMaps, "Nature économique", imputation.getEconomicNatureAsString());
